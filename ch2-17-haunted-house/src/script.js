...
gui.add(graveMaterial, "displacementScale").min(0).max(10).step(0.01);
gui.add(graveMaterial, "roughness").min(0.01).max(10).step(0.01);
...
const tick = () => {
  ...
  camera.lookAt(0, 0, 0); // Make the camera look at the center of the circle
*/

  //camera.position.z += elapsedTime * 0.1;

  //console.log(camera.position.z);
  //camera.position.z = Math.PI * elapsedTime * 0.1;
  //camera.position.y = Math.PI * elapsedTime * 0.1;

  //camera.position.x = -(elapsedTime * 1);
  // Render
